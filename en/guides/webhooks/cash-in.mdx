---
title: 'cash_in event'
description: 'Notification sent when a SPEI or OXXO cash-in is confirmed'
---
...
| `clabe` | Source CLABE | `null` |
| Time to confirmation | Seconds to minutes | Minutes to hours after paying at register |
| Additional identifier | `referenceNumerical` | `referenceNumerical` |

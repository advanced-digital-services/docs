...
<ParamField path="amountCentavos" type="integer" required>
  Valor em centavos MXN. **Mínimo: `1000` centavos ($10,00 MXN)** — piso do banco parceiro; abaixo disso a API retorna `400` com code `CASHIN_MIN_AMOUNT`. Ex.: `50000` = $500,00 MXN.
</ParamField>

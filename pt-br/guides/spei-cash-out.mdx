...
O `transactionId` (UUID) é o identificador oficial da transação — é o mesmo valor entregue nos webhooks; use-o para correlacionar eventos e consultar a transação. O campo `id` numérico está **deprecated** e será removido futuramente.

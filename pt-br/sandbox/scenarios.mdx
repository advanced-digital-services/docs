...
Adicione o header `X-Sandbox-Scenario: <cenário>` a qualquer chamada de cash-in, cash-out ou OXXO. Sem o header, o sandbox usa o cenário `success` por padrão.
...
| `error:oxxo-expired` | `201 PENDING` | `EXPIRED` (apenas OXXO) |

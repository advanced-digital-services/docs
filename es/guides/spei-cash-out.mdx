...
El `transactionId` (UUID) es el identificador oficial de la transacción — es el mismo valor entregado en los webhooks; úsalo para correlacionar eventos y consultar la transacción. El campo `id` numérico está **deprecated** y será removido en el futuro.

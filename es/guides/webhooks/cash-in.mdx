...
description: 'Notificación enviada cuando un SPEI o OXXO cash-in es confirmado'
---
...
| `X-NTXPay-Delivery` | UUID único del envío |
...
| `clabe` | CLABE de origen | `null` |
| Tiempo hasta confirmación | Segundos a minutos | Minutos a horas tras pagar en caja |
...
Ver el [guía de implementación](/es/guides/webhooks/implementation) para Python y PHP.
